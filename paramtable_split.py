...
def ParamFetch(filepath,i):
    ...
    q = delta = a11 = a12 = kb = th1 = th2 = None
    ...
    for i, line in enumerate(lines):
        ...
        pass
    f.close()
    return q, delta, a11, a12, kb, th1, th2
...
table.write("q d A11 A12 K3B TH1 TH2 seg\n")
...
for i in range(3):
    for root, dirs, files in os.walk(rootdir,topdown=True):
        ...
        if os.path.isfile(tabdir):
            ...
            table.write("{0} {1} {2} {3} {4} {5} {6} {7}\n".format(Params[0],Params[1],Params[2],Params[3],Params[4],Params[5],Params[6],i))